...
<div class="header">
  ...
  <div class="headernav">
    ...
    <a href="./router_fete" class="nav" class="active">Fetes</a>
...
<!--Saison-->
<div class="container">
  <a href="">Fetes recipes</a>
  <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" class="filtrer">
  <label for="filter">filtrer par recette Fete</label>
      <select name="filter" id="filter">
         <option value="mariage" name="mariage" selected >mariage</option>
         <option value="circoncision" name="circoncision">circoncision</option>
         <option value="Aid" name="Aid">Aid</option>
         <option value="Achoura" name="Achoura">Achoura</option>
         <option value="anniversaire" name="anniversaire">anniversaire</option>
      ...
      $recette_fete_control=new ClientController();
   $recette_fete=$recette_fete_control->recupererRecetteFeteController();
   if(isset($_POST['submit_filter'])){
    if(!empty($_POST['filter'])) {
       $selected_option = $_POST['filter'];
    }
    
    $recette_fete=$recette_fete_control->recupererRecetteFeteFilterController($selected_option);}
   ?>
  <ul class="cards">

   <?php while($row = $recette_fete->fetch(PDO::FETCH_BOTH)){ ?>  
    <li class="card">
      <div>
