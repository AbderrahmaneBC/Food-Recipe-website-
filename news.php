...
class NewsView{
   ...
   $recette=$recette_control->recupererRecetteController();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--.......................................................................................-->
<?php $news_control=new ClientController();
   $news=$news_control->recupererNewsController(); ?>  
<!--Plats-->
<div class="container">
  <a href="">News</a>
  <ul class="cards">
  <?php while($row = $news->fetch(PDO::FETCH_BOTH)){ ?>  
    <li class="card">
      <div>
        <img src="../admin2/uploaded_img/<?php echo $row['imagenews'] ?>" alt="" width=100% height=200px>
        <h3 class="card-title"><?php echo $row['titrenews'] ?>  </h3>
        <div class="card-content">
          <p><?php
           $paragraph=mb_substr($row['paragraphenews'],0,60,'UTF-8');
      ...
      <div class="card-link-wrapper">
        <a href="router_news_page.php?idnews=<?php echo $row['idnews']; ?>" class="card-link">Afficher plus</a>
      </div>
    </li>
    <?php
   }
