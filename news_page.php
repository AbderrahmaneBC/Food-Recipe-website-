...
class NewsPageView{
    ...
    $recuperernews_control=new ClientController();
    $id=$_GET['idnews'];
   $recuperer=$recuperernews_control->recupererNewsControllerId($id);
...
<div class="about" >
		<div class="container">
        <h1 class="title_recipe"><?php echo $row['titrenews']; ?></h1>

			<div class="row">

		        <div class="col-md-6">
		        	<div><img src="../admin1/uploaded_img/<?php echo $row['imagenews'] ?>" style="max-width: 100%;"></div>
		        </div>
		        <div class="col-md-6">
		        	<h1 class="about_text"><strong>Plus sur  <span class="color"><?php echo $row['titrenews']; ?></span></strong></h1>
		        	<p class="about_taital"> <?php echo $row['paragraphenews']; ?></p>
