...
<!--.......................................................................................-->
<?php $ingredient_control=new ClientController();
   $ingredient=$ingredient_control->recupererIngredientController();
    ?>  
<!--Plats-->
<div class="container">
  <a href="">Ingredients</a>
  <ul class="cards">
  <?php while($row = $ingredient->fetch(PDO::FETCH_BOTH)){ ?>  
    <li class="card">
      <div>
        <img src="../admin2/uploaded_img/<?php echo $row['imageing'] ?>" alt="" width=100% height=200px>
      ...
      <div class="card-link-wrapper">
        <a href="router_ingredient.php?idingredient=<?php echo $row['idingredient']; ?>" class="card-link">Afficher plus</a>
      </div>
    </li>
    <?php
   }
